...
class MyApp:
    def __init__(self) -> None:
        ...
        self.index = None
        self.load_pdf("17-bdmkt-05910317_fundamentalsfinancialplanningbrochure-v1.pdf")  # Replace with your actual PDF file path
...
def respond(
    ...
    system_message: str = "You are a financial advisor. Remember to greet the user warmly, ask relevant questions, and offer supportive and insightful responses.",
    max_tokens: int = 150,
